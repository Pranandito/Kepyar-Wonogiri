    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-18 main-text">
                ...
                @php
                    // Pisahkan paragraf berdasarkan <br>
                    $paragraphs = explode('<br>', $galeri->body);
                @endphp

                {{-- Tampilkan teks di Display-7 --}}
                @foreach ($paragraphs as $paragraph)
                    @php
                        $paragraph = strip_tags($paragraph, '<p><a><span><strong><em><ul><li><ol><br>');
                        $paragraph = htmlspecialchars_decode($paragraph);
                    @endphp
